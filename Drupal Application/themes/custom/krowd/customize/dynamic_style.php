...
<?php
    ...
    if($customize){
        ...
        if(isset($customize['theme_color']) && !empty($customize['theme_color'])){
          $style .= "--krowd-theme-color:{$customize['theme_color']};";
        } 
        if(isset($customize['theme_color_second']) && !empty($customize['theme_color_second'])){
          $style .= "--krowd-theme-color-second:{$customize['theme_color_second']};";
        }
        if(isset($customize['theme_color_three']) && !empty($customize['theme_color_three'])){
          $style .= "--krowd-theme-color-three:{$customize['theme_color_three']};";
        }
        if(isset($customize['font_family_primary']) && !empty($customize['font_family_primary']) && $customize['font_family_primary'] !='---'){
          $style .= "--krowd-font-sans-serif:{$customize['font_family_primary']};";
        } 
        if(isset($customize['font_family_second']) && !empty($customize['font_family_second']) && $customize['font_family_second'] !='---'){
          $style .= "--krowd-heading-font-family:{$customize['font_family_second']};";
        } 
